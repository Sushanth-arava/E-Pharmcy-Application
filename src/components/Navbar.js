...
class Navbar extends Component {
  ...
  render() {
    ...
    return (
      <nav
        className="navbar navbar-expand-sm navbar-dark bg-info border-bottom border-bottom border-dark "
        style={{ height: "4.5rem", width: "100vw",color:"red" }}
      >
        <div className="container">
          ...
          <div
            class="collapse navbar-collapse bg-info "
