...
class Login extends Component {
  ...
  render() {
    ...
    document.body.style.background =
      "url('https://thumbs.dreamstime.com/z/pharmacy-otc-products-turkey-64209494.jpg') no-repeat center center/cover";
/*https://previews.123rf.com/images/redspruce/redspruce1506/redspruce150600031/40901625-seamless-health-care-and-medicine-doodle-background.jpg*/
    return (
      <React.Fragment>
        <Helmet>
          <title>Login </title>
